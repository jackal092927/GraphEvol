...
def make_dataset(
    ...
    for i in range(num_graphs):
        G = generate_pa_graph(n_nodes=n_nodes, m=m, er_prob=er_prob, seed=SEED + i)
...
def main():
    ...
    samples = make_dataset(num_graphs=120, n_nodes=30, m=2, er_prob=0.03)
    ...
    out_dir = "outputs_tda" if args.model == "mlp" else "outputs_gat"
